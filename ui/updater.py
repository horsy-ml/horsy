...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(666, 152)
        MainWindow.setMinimumSize(QtCore.QSize(666, 152))
        MainWindow.setMaximumSize(QtCore.QSize(666, 152))
        icon = QtGui.QIcon()
...
"")
        ...
        self.progressBar_cli = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar_cli.setProperty("value", 0)
        self.progressBar_cli.setTextVisible(False)
        self.progressBar_cli.setObjectName("progressBar_cli")
        self.verticalLayout.addWidget(self.progressBar_cli)
        self.progressBar_gui = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar_gui.setProperty("value", 0)
        self.progressBar_gui.setTextVisible(False)
        self.progressBar_gui.setObjectName("progressBar_gui")
        self.verticalLayout.addWidget(self.progressBar_gui)
        spacerItem = QtWidgets.QSpacerItem(0, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout.addItem(spacerItem)
        self.buttons_lay = QtWidgets.QWidget(self.centralwidget)
        self.buttons_lay.setObjectName("buttons_lay")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.buttons_lay)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.launch_button = QtWidgets.QPushButton(self.buttons_lay)
        self.launch_button.setEnabled(False)
        self.launch_button.setObjectName("launch_button")
        self.horizontalLayout.addWidget(self.launch_button)
        self.exit_button = QtWidgets.QPushButton(self.buttons_lay)
        self.exit_button.setObjectName("exit_button")
        self.horizontalLayout.addWidget(self.exit_button)
        self.verticalLayout.addWidget(self.buttons_lay)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "horsy updater"))
        self.horsyname.setText(_translate("MainWindow", "horsy updater"))
